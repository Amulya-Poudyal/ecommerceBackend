...
export const registerUser = async (req, res) => {
    ...
    res.status(201).json({ message: "Registered & logged in", user: { id: newUser[0].id, username, email } });
};
...
export const loginUser = async (req, res) => {
    ...
    res.json({ message: "Logged in successfully", user: { id: user[0].id, username: user[0].username, email } });
};
